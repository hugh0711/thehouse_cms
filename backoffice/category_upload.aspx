<%@ Page Title="" Language="VB" MasterPageFile="~/backoffice/master/admin.master" AutoEventWireup="false"
    CodeFile="category_upload.aspx.vb" Inherits="backoffice_category_upload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel runat="server" ID="Panel2">
        <table border="0">
            <tr>
                <td>
                    預覽:
                    <div id="divPreview" style='<%= String.Format("overflow: hidden; width: {0}px; height: {1}px; margin-left: 5px;", ViewState("FunctionSettings").CategoryImageWidth, ViewState("FunctionSettings").CategoryImageHeight)  %>'>
                        <asp:Image runat="server" ID="imgPreview" />
                    </div>
                    <span id="ratio" style="display:none;"><%=ViewState("FunctionSettings").CategoryImageRatio%></span>
                </td>
                <td>
                    選取類別圖片顯示範圍:<br />
    ...
    <asp:Panel runat="server" ID="Panel4">
        ...
        <center>
            找不到類別，
            <asp:HyperLink runat="server" NavigateUrl="~/backoffice/categories.aspx">按此返回類別管理</asp:HyperLink>
            </center>
        <br />
        <br />
        <br />
