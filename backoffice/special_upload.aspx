<%@ Page Title="" Language="VB" MasterPageFile="~/backoffice/master/Admin.master" AutoEventWireup="false" CodeFile="special_upload.aspx.vb" Inherits="backoffice_special_upload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:HiddenField ID="hfdImageID" runat="server" />
    ...
    <asp:Panel runat="server" ID="Panel4">
        ...
        <center>
            找不到類別，
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/backoffice/products.aspx">按此返回產品管理</asp:HyperLink>
            </center>
        <br />
        <br />
        <br />
